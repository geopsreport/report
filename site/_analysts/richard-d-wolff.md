...
summary: |
  As global economic and political power continues to shift in 2025, recent analyses highlight deepening contradictions within Western capitalism, the rise of alternative economic blocs, and the intensifying social and class struggles shaping policy responses across the U.S. and Europe.
  
  A key development, as detailed by **Richard D. Wolff** in his latest report, is the increasing reliance on "military Keynesianism" in both the U.S. and Europe. This approach—using government spending on military and security sectors to stimulate economic growth—has become more pronounced as traditional capitalist mechanisms falter. Wolff notes that this trend exposes "the inherent contradictions of capitalism that provoke both war and civil conflict," suggesting that military spending is now a primary tool to mask deeper systemic vulnerabilities.
  
  Meanwhile, the economic divergence between the G7 and BRICS nations is becoming starker. **Wolff** points out that while the U.K. and other G7 economies face stagnation or contraction, China and several BRICS countries continue to post robust growth. This shift is not only economic but also political, as the BRICS bloc increasingly asserts itself as a counterweight to Western dominance. The majority view among analysts is that this trend will persist, with high confidence that "the global economic center of gravity will continue moving eastward," and that the G7's influence will further erode.
  
  On the domestic front, the U.S. is experiencing intensified class and social tensions. The ongoing deindustrialization, driven by capital flight to countries like China, has exacerbated economic inequality and social crises. **Wolff** argues that this has led to "a growing sense of betrayal among workers" and a fragmentation of traditional political affiliations, particularly among the employee class. This discontent is fueling both left-wing and right-wing populist movements, with mainstream politicians struggling to address the root causes of mass anger.
  
  Looking ahead, the prevailing trend is one of increasing instability within Western capitalist societies, both economically and politically. There is a high chance that governments will double down on military and security spending as a stopgap, while social movements advocating for systemic change—particularly those focused on workplace democracy and anti-capitalism—will continue to gain traction. The rise of BRICS and the relative decline of the G7 are "most definitely" set to reshape the global order, with multipolarity and new forms of economic cooperation likely to define the coming years.
articles:
